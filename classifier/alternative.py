...
class LeftRightEconomicScorer:
    def __init__(self, model_name="mlburnham/Political_DEBATE_large_v1.0"):
        ...
        self.left_right_hypotheses = {
            ...
            "The text directly expresses that corporations should pay higher taxes": (1.0, "left"),
            "The text directly expresses that wealthy individuals should pay higher tax rates": (1.0, "left"),
            "The text directly expresses that government should increase spending on healthcare": (1.0, "left"),
            "The text directly expresses that government should increase spending on education": (1.0, "left"),
            "The text directly expresses that unemployment benefits should be expanded": (1.0, "left"),
            "The text directly expresses that government should provide universal healthcare": (1.0, "left"),
            "The text directly expresses that banks and financial institutions should be heavily regulated": (1.0, "left"),
            "The text directly expresses that environmental regulations on business are necessary": (1.0, "left"),
            "The text directly expresses that utilities should be publicly owned": (1.0, "left"),
            "The text directly expresses that government should break up large corporations": (1.0, "left"),
            "The text directly expresses that minimum wage laws should be strengthened": (1.0, "left"),
            "The text directly expresses that unions should have more power": (1.0, "left"),
            "The text directly expresses that government should reduce income inequality": (1.0, "left"),
            "The text directly expresses that public investment creates jobs": (1.0, "left"),
            "The text directly expresses that social safety nets should be expanded": (1.0, "left"),
            "The text directly expresses that government should have an active role in the economy": (1.0, "left"),

            # Right Economic Positions
            "The text directly expresses that corporate tax rates should be lowered": (1.0, "right"),
            "The text directly expresses that income taxes should be reduced": (1.0, "right"),
            "The text directly expresses that government spending on social programs should be cut": (1.0, "right"),
            "The text directly expresses that welfare programs should be reduced": (1.0, "right"),
             "The text directly expresses that healthcare should be privatized": (1.0, "right"),
            "The text directly expresses that education should be privatized": (1.0, "right"),
            "The text directly expresses that financial regulations should be eliminated": (1.0, "right"),
            "The text directly expresses that environmental regulations hurt business competitiveness": (1.0, "right"),
            "The text directly expresses that government services should be privatized": (1.0, "right"),
            "The text directly expresses that large corporations drive economic growth": (1.0, "right"),
            "The text directly expresses that minimum wage laws hurt employment": (1.0, "right"),
            "The text directly expresses that unions hurt economic competitiveness": (1.0, "right"),
            "The text directly expresses that income inequality reflects merit and effort": (1.0, "right"),
            "The text directly expresses that private investment is more efficient than public": (1.0, "right"),
            "The text directly expresses that social programs create dependency": (1.0, "right"),
            "The text directly expresses that public assets and state-owned enterprises should be privatized": (1.0, "right"),
        }
