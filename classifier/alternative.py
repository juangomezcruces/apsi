...
class LeftRightEconomicScorer:
    def __init__(self, model_name="mlburnham/Political_DEBATE_large_v1.0"):
        ...
        self.left_right_hypotheses = {
            ...
            "The text expresses that public investment creates jobs": (1.0, "left"),
            "The text expresses that social safety nets should be expanded": (1.0, "left"),
            ...
            "The text expresses that large corporations drive economic growth": (1.0, "right"),
