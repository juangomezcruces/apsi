...
class LeftRightEconomicScorer:
    def __init__(self, model_name="mlburnham/Political_DEBATE_large_v1.0"):
        ...
        self.left_right_hypotheses = {
            ...
            "The text expresses that the state should own and control the means of production and major industries": (1.2, "left"),

            "The text expresses that market mechanisms should be replaced by central state planning and allocation": (1.2, "left"),
            ...
            "The text expresses that the means of production and major industries should be privately owned and free from state control": (1.2, "right"),

            "The text expresses that free market mechanisms should replace state planning and allocation": (1.2, "right"),
