...
class LeftRightEconomicScorer:
    def __init__(self, model_name="mlburnham/Political_DEBATE_large_v1.0"):
        ...
        self.left_right_hypotheses = {
           ...
           "The text expresses that the state should play an active role in managing the economy": (1.0, "left"),
            "The text expresses that government intervention is necessary to correct market failures": (1.0, "left"),
            "The text expresses that public institutions should coordinate economic development": (1.0, "left"),
            "The text expresses that the government has a responsibility to protect workers and citizens from economic hardship": (1.0, "left"),
            "The text expresses that the state should ensure equal access to public services": (1.0, "left"),
            "The text expresses that economic planning requires government oversight": (1.0, "left"),
            "The text expresses that public resources should be used to promote social welfare": (1.0, "left"),

            "The text expresses that the private sector is better suited than government to drive economic growth": (1.0, "right"),
            "The text expresses that the role of the state in the economy should be reduced": (1.0, "right"),
            "The text expresses that market competition produces better outcomes than government management": (1.0, "right"),
            "The text expresses that businesses should operate with minimal government interference": (1.0, "right"),
            "The text expresses that economic freedom drives prosperity": (1.0, "right"),
            "The text expresses that deregulation benefits the economy": (1.0, "right"),
            "The text expresses that attracting private investment is a primary government goal": (1.0, "right"),
        }
